...
//--------------------------------------------------
- (void)uploadStart {
    // BASIC認証用ユーザ名、パスワードを設定
    NSString *basic_uid = @"u_hoge";        // ユーザ名
    NSString *basic_password = @"p_hoge";   // パスワード
    
    // URLパス
    NSString *urlPath = @"http://%@:%@@localhost/test/uploadsample.php";
    
    // URLを設定 with BASIC認証
    NSString *urlStr = [NSString stringWithFormat:urlPath, basic_uid, basic_password];
